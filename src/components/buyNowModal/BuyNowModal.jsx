                ...
                <DialogBody className="">
                    ...
                    <div className="mb-3">
                        <input
                            ...
                            className='bg-purple-50 border border-purple-200 px-2 py-2 w-full rounded-md outline-none text-purple-600 text-purple-600 placeholder-purple-300'
                        />
                    </div>
                    ...
                    <div className="">
                        <Button
                            ...
                            className="w-full px-4 py-3 text-center bg-violet-300 hover:bg-violet-500 border-transparent dark:border-gray-700 rounded-lg"
                        >
                            Buy now
                        </Button>
                    </div>
