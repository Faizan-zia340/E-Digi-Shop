                                        ...
                                        <div className="mb-2 flex">
                                            ...
                                            <div className="ml-6 flex text-sm">
                                                <button type="button" className="flex items-center space-x-1 px-2 py-1 pl-0">
                                                    <Trash size={12} className="text-purple-500" />
                                                    <span className="text-xs font-medium text-purple-500">Remove</span>
                                                </button>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="flex gap-4 mb-6">
                                    <button
                                        className="w-full px-4 py-3 text-center text-gray-100 bg-violet-600 border border-transparent dark:border-gray-700 hover:border-purple-500 hover:text-violet-700 hover:bg-violet-100 rounded-xl"
                                    >
                                        Buy now
                                    </button>
                                </div>
