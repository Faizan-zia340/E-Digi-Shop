            ...
            <section aria-labelledby="cart-heading" className="rounded-lg bg-white lg:col-span-8">
              ...
              <ul role="list" className="divide-y divide-gray-200">
                {cartItems.length > 0 ? (
                  ...
                  <h1 className="py-4 text-center text-lg font-semibold">Cart is empty</h1>
                )}
              </ul>
            </section>
            ...
            >
              ...
              <div>
                ...
                <div className="px-2 pb-4 font-medium text-green-700">
                  <button className="w-full px-4 py-3 text-center text-white bg-violet-600 hover:bg-violet-700 rounded-xl">
                    Buy now
                  </button>
                </div>
              </div>
