                            ...
                            <div>
                                ...
                                <div className="px-2 pb-4 font-medium text-green-700">
                                    <div className="flex gap-4 mb-6">
                                        <button
                                            className="w-full px-4 py-3 text-center text-gray-100 bg-violet-600 border border-transparent dark:border-gray-700 hover:border-putple-500 hover:text-purple-700 hover:bg-purple-100 rounded-xl"
                                        >
                                            Buy now
                                        </button>
                                    </div>
